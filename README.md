...
- android.permission.WRITE_EXTERNAL_STORAGE : 구형폰에서 사용자가 동영상 파일을 삭제하는 경우

- android.permission.MANAGE_EXTERNAL_STORAGE : 신형폰에서 폴더에 저장된 동영상파일을 찾거나 삭제하는 경우

android.permission.READ_MEDIA_VIDEO : MediaStore의 동영상 정보를 가져오기 경우

그 외의 어떠한 자료도 수집 및 처리하지 않습니다.
